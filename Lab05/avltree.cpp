...
operator=( const AvlTree & rhs )
{
	...
	SingleRotations = rhs.SingleRotations;
    DoubleRotations = rhs.DoubleRotations;
    RightLinksFollowed = rhs.RightLinksFollowed;
    LeftLinksFollowed = rhs.LeftLinksFollowed;
    }
    return *this;
}
...
*/
{
  double pathLength = int_path_length(root, 0);
    // YOUR CODE HERE
  return pathLength/num_nodes;  // stub, remove after writing your code
}
...
int AvlTree::int_path_length(AvlNode *t, int depth)
{
  ...
  return d; // put your actual return value here when you write this function
}
...
void AvlTree::doubleWithLeftChild( AvlNode * & k3 ) const
{
  DoubleRotations++;
    ...
    SingleRotations = SingleRotations-2;
}
