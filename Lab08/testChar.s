...
.lcomm __ZSt8__ioinit,16
	.align 2
.globl __Z12passIntValuec
	.def	__Z12passIntValuec;	.scl	2;	.type	32;	.endef
__Z12passIntValuec:
	push	ebp
	mov	ebp, esp
	sub	esp, 4
	...
	ret
	.align 2
.globl __Z10passIntRefRc
	.def	__Z10passIntRefRc;	.scl	2;	.type	32;	.endef
__Z10passIntRefRc:
	push	ebp
	mov	ebp, esp
	mov	eax, DWORD PTR [ebp+8]
...
_main:
	...
	mov	DWORD PTR [esp], eax
	call	__Z12passIntValuec
	lea	eax, [ebp-1]
	mov	DWORD PTR [esp], eax
	call	__Z10passIntRefRc
	mov	eax, 0
	leave
	ret
...
L15:
	...
	ret
	.align 2
	.def	__GLOBAL__I__Z12passIntValuec;	.scl	3;	.type	32;	.endef
__GLOBAL__I__Z12passIntValuec:
	push	ebp
	mov	ebp, esp
	sub	esp, 8
	...
	.section	.ctors,"w"
	.align 4
	.long	__GLOBAL__I__Z12passIntValuec
	.text
	.align 2
	.def	__GLOBAL__D__Z12passIntValuec;	.scl	3;	.type	32;	.endef
__GLOBAL__D__Z12passIntValuec:
	push	ebp
	mov	ebp, esp
	sub	esp, 8
	mov	DWORD PTR [esp+4], 65535
	...
	.section	.dtors,"w"
	.align 4
	.long	__GLOBAL__D__Z12passIntValuec
