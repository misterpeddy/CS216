...
.lcomm __ZSt8__ioinit,16
	.align 2
.globl __Z12passIntValuef
	.def	__Z12passIntValuef;	.scl	2;	.type	32;	.endef
__Z12passIntValuef:
	push	ebp
	mov	ebp, esp
	mov	eax, 0x00000000
	...
	ret
	.align 2
.globl __Z10passIntRefRf
	.def	__Z10passIntRefRf;	.scl	2;	.type	32;	.endef
__Z10passIntRefRf:
	push	ebp
	mov	ebp, esp
	mov	edx, DWORD PTR [ebp+8]
...
_main:
	...
	mov	eax, DWORD PTR [ebp-4]
	mov	DWORD PTR [esp], eax
	call	__Z12passIntValuef
	lea	eax, [ebp-4]
	mov	DWORD PTR [esp], eax
	call	__Z10passIntRefRf
	mov	eax, 0
	leave
	ret
...
L15:
	...
	ret
	.align 2
	.def	__GLOBAL__I__Z12passIntValuef;	.scl	3;	.type	32;	.endef
__GLOBAL__I__Z12passIntValuef:
	push	ebp
	mov	ebp, esp
	sub	esp, 8
	...
	.section	.ctors,"w"
	.align 4
	.long	__GLOBAL__I__Z12passIntValuef
	.text
	.align 2
	.def	__GLOBAL__D__Z12passIntValuef;	.scl	3;	.type	32;	.endef
__GLOBAL__D__Z12passIntValuef:
	push	ebp
	mov	ebp, esp
	sub	esp, 8
	mov	DWORD PTR [esp+4], 65535
	...
	.section	.dtors,"w"
	.align 4
	.long	__GLOBAL__D__Z12passIntValuef
